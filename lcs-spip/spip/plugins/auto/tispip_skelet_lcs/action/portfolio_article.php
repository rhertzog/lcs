...
//    echo 'tispipskelet_conf/article/afficher_portfolio_'.$id_rubrique."<br />";
//    echo _request('afficher_portfolio_'.$id_article)."<br />";

	//ecrire la valeur dans la table meta tispipskelet_conf
    include_spip("inc/securiser_action");
    ecrire_config('tispipskelet_conf/article/afficher_portfolio_'.$id_article, _request('afficher_portfolio_article_'.$id_article));
