...
// $LastChangedDate: 2009-08-19 11:34:37 +0200 (mer, 19 aoû 2009) $
								...
								switch($format_abo) {
									case 'html':
										...
										if (FALSE === strpos($ventre_html, '</html>')) {
											...
											// Si on trouve les tags HTML cela veut dire que l'auteur veut pouvoir g�rer lui m�me la partie <head> ainsi que le lien de d�sabonnement
