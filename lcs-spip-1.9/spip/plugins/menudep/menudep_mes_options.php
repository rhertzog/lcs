<?php 
	...
	// $LastChangedDate: 2007-12-22 19:37:31 +0100 (sam., 22 dÃ©c. 2007) $
	...
	*****************************************************/
	...
	define("_MENUDEP_DEFAULT_VALUES_ARRAY", 
	 	serialize(
			array(
				'menudep_id' => "#side"		// id du bloc contenant le menu de navigation- Modif de l'id par defaut
				...
				, 'menudep_bgcolor' => "red" // couleur par défaut du fond
				, 'menudep_border' => "0px solid gray" // bordure par défaut 
