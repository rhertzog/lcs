 ...
 * @version   SVN: $Id: class.PSI_Interface_Plugin.inc.php 228 2009-06-03 05:56:44Z bigmichi1 $
...
interface PSI_Interface_Plugin
{
     ...
     * build the xml
     *
     * @param string $strEncFrom encoding to convert from to UTF8
     *
     * @return SimpleXMLObject entire XML content for the plugin which than can
     *         be appended to the main XML
     */
    function xml($strEncFrom);
}
?>
