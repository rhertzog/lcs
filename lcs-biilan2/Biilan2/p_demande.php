...
<table border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td><b>Sélectionner les demandes à traiter :</b><br><br></td>
  </tr>
  <tr>
		<td><select size="7" STYLE="background:#F0E4C8;color:#000080" NAME="val[]" MULTIPLE>
            ...
            {echo "<option value=\"" . $resultat["id"] . "\">Compétence " . $resultat["cpt"] . " demandée le " . $resultat["date"] . " par  " . $resultat["fulleleve"] . "   (" . $resultat["classe"] . ") </option>";}
            ?>
            </td>	</tr>
	<tr>
		<td align="center" STYLE="color:#000080;"><a href="c_cndp.php"><br>Rappel des compétences.</a></td>
	</tr>
	<tr><td><br></td></tr>
