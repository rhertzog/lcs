...
<form method="post" enctype='multipart/form-data' action="import1.php">
...
<?php
 ...
 if (is_admin("Biilan_is_admin",$username)!="Y") 
...
<table WIDTH=100%>
	<tr>
		<td ALIGN="MIDDLE"><IMG SRC="../Images/ping.png"><BR><input type="submit" name="button" value="Importer les données"></td>
	</tr>
</table>

<br><br>

<div class="remarque"><center>Si vous êtes certain de vouloir importer les données,<br>
