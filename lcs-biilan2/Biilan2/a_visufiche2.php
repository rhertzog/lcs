...
{die ("<div class=\"texte\"><h1>Visualisation de la fiche de position d'un élève</h1></div><br><br>
...
print"<div class=\"texte\"><h1>Consultation de la fiche de position de $dbeleve - $dbclasse</h1><p><a href=\"javascript:window.print()\"><img src=\"Images/pingimp.png\" BORDER=\"0\" ALIGN=\"right\"></a><br><br></p>";
print "<br><br>";
print "<h2>&nbsp;&nbsp;&nbsp;&nbsp;ETAT DES DEMANDES</h2>";

// Déclaration de l'initiale de l'établissementpour l'affichage des compétences
...
print "<h2>&nbsp;&nbsp;&nbsp;&nbsp;RESULTAT</h2>";
		...
		//print "<ul>";
		//print "<br><div class=affichok>Compétences attestées : $total / $res5 <br><br>" ;
		//print "</ul>";
