...
if (is_admin("Biilan2_is_admin",$username)!="Y"){die("L'accès à BiiLan est ouvert, toutefois<br>n'&eacute;tant pas administrateur, vos droits sont restreints<br><br>");}
