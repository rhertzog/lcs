...
if (empty($_POST["prof"]) or empty($_POST["discip"]))	//on vérifie avec empty si les champs sont vides	
	{print "<div class=avertissement><br><br><br>Veuillez compléter les champs.<br><br><br><br></div>";}
else
	{
	foreach ( $prof as $id )	
		{mysql_query("UPDATE  profs_tbl SET  `discipline` =  '$_POST[discip]' WHERE  fullprof='$id'");
		print "<div class=confirm><br><br><br>Opération réalisée avec succès :<br>
			<i><b>$id</b>  est enregistré en<b> $_POST[discip]</b></i><br></div>";}
	}

// si tous les profs affectés à une discipline, on affiche la page : mise à jour annuelle
...
if ($nbresultat==0)
	{
	print"<div class=confirm><br />Tous les professeurs sont affectés dans une discipline <br /></div>";
  	print"<br><br>";
	...
	{
	// Retour à la page d'affectation des disciplines
	print"<br><br>";
