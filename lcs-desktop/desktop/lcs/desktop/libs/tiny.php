...
<script type="text/javascript">
	$().ready(function() {
		...
		}).execCommand('fullpage');
	});
</script>
<!-- /TinyMCE -->

<form method="post" action="dump.php?example=true">
	<div>
	<fieldset>
		<legend>Ecrire une page html</legend>
		<ul>
		<li>
		<label for="name_test_tiny">Nom de fichier</label>
		<input type="text" name="name_test_tiny" id="name_test_tiny" value="test" size="12" />
		</li>
		</ul>
	</Fieldset>
		<!-- Gets replaced with TinyMCE, remember HTML in a textarea should be encoded -->
		<div>
			<textarea id="elm1" name="elm1" rows="15" cols="60" style="width: 80%" class="tinymce">
				&lt;p&gt;
