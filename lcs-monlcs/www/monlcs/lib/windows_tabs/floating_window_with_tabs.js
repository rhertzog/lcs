	...
	************************************************************************************************************/	
	...
	switch(floating_window_skin){
		case 2:
			...
			var tabRightInActive = "../Styles/images/skin2_tab_right_inactive.gif";
			var tabRightActive = "../Styles/images/skin2_tab_right_active.gif";
			var tabImagePrefix = "../Styles/images/skin2_tab_right_";		
			var closeButtonMouseOverColor = '#006BF8';
			break;
		default:
			
			var tabRightInActive = "../Styles/images/tab_right_inactive.gif";
			var tabRightActive = "../Styles/images/tab_right_active.gif";
			var tabImagePrefix = "../Styles/images/tab_right_";
	...
	*/	
	...
	function createStatusBar(inputObj,noResize)
	{
		...
		img.src = '../Styles/images/floating_window_resize.gif';
