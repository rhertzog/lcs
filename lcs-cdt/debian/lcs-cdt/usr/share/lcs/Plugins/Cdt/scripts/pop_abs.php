...
<BODY>
<H3 align="center"><U> <?php echo $nom;?></U></H3>
<?
...
<FORM action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" name="planning" id="planning">
	...
	<TABLE align="center" >
		<TR>
			...
			<TD width="150" align="center"class="libre"  > <?echo datefr2($Lundi)?> - <?echo datefr2($Samedi);?></TD>
...
// Affichage des jours et dates de la semaine en haut du tableau"j-M-Y", 
	for ($i=0; $i<=5; $i++) {
		$TS = $Lundi+$i*86400;
		echo '<TH width="15%" > <font face="Arial" size="2" color="#FFFFFF" >'.LeJour($TS)."</TH>\n";
	}
?>
		</TR>
<?php
	...
	for ($h=0; $h<=9; $h++) 
		...
		echo "<TH><font face='cursive'size='2' color='#FFFFFF' >".$horaire[$h]."</TH>\n";
