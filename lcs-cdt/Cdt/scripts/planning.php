...
if (isset($_GET['ladate']) &&(isset($_GET['inser'])))
	...
	<P STYLE="margin-left: 1cm"><FONT color="#003366"><B>Intitulé du devoir : 
	</B><INPUT TYPE=TEXT NAME="sujet" SIZE=28 MAXLENGTH=28> &nbsp &nbsp
	<B>Durée </B><INPUT TYPE=TEXT NAME="durée" SIZE=1 MAXLENGTH=1>heure(s)
...
<!-- Affichage des boutons -->	
	...
	<TABLE align="center" >
		<TR>
			<TD width="150" align="center" ><INPUT type="submit" name="mprec" value="  <<  " title="Mois précédent"></TD>
			<TD width="150" align="center" ><INPUT type="submit" name="prec" value="  <  " title="Semaine précédente"></TD>
