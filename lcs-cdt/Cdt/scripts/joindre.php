...
if (!isset($_POST['Valider']))
	...
	echo '
	<DIV ALIGN=LEFT>
	<P><H4><b>1. </b> Sélectionner le document à joindre (2 Mo maxi) : <BR><INPUT TYPE=FILE NAME="FileSelection1" SIZE=30></H4></P>
	<P><H4><b>2. </b> Indiquer le nom du lien  : <BR><INPUT TYPE=TEXT NAME=nom_lien SIZE=30></H4></P>
	<P><H4><b>4. </b>Indiquer le sous-répertoire de votre "public_html" dans lequel sera enregistré le fichier : 
	<font size=2>  s\'il n\'existe pas, il sera créé </font><br>
	<INPUT TYPE=TEXT NAME=sousrep Value=Docs_Cdt SIZE=30></H4></P>
	<P><H4><b>5. </b>Le bouton <b> Valider </b> transfert le fichier sélectionné sur le serveur et insère automatiquement le lien  </P>
