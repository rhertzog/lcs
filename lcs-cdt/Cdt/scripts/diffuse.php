...
if (!isset($_POST['Valider']))
	...
	if (mysql_num_rows($result)==0) 
		...
		pas orthographiée différemment pour les autres classes .<BR><BR><DIV align="center" ><input type="submit" name="Valider"
		value="OK " ></DIV>';
	//sinon, affichage des classes de même niveau 	
	else
		{
		echo '<H4> Lorsque vous enregistrerez votre commentaire de <B>'.$mat.'</B> en <B>'.$clas_act.'</B> , il sera diffusé vers les
		classes que vous aurez sélectionnées ci-dessous </H4>';
		echo '<TABLE align="center" >
		<TR>
		<TD width="30" align="center"><H5></TD><TD  align="center"><H5>Classe</H5></TD><TD  align="center"><H5>Date du cours</H5></TD>
		<TD  align="center"><H5>Date "à faire" </H5></TD>
		</TR>';
