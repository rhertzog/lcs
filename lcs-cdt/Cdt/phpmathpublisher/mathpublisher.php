...
$dirfonts="/usr/share/lcs/Plugins/Cdt/phpmathpublisher/fonts";
// or $dirfonts=dirname(__FILE__)."/phpmathpublisher/fonts";

// absolute path to the images directory
$dirimg="/usr/share/lcs/Plugins/Cdt/phpmathpublisher/img";
...
*/
global $dirimg;
$nameim = md5(trim($text).$size);
$nameimg=substr($nameim,0,5).'.png';
$v=detectimg($nameimg);
if ($v==0)
	{
	...
	ImagePNG($formula->image,$dirimg."/math_".$nameimg);
	}
$valign=$v-1000;
return '<img src="'.$pathtoimg."math_".$nameimg.'" style="vertical-align:'.$valign.'px;'.' display: inline-block ;" alt="'.$text.'" title="'.$text.'"/>';
}
