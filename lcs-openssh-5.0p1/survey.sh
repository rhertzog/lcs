...
CFLAGS="-Wall -g -O2 -Wall -Wpointer-arith -Wuninitialized -Wsign-compare -Wno-pointer-sign -fstack-protector-all -std=gnu99 "
CPPFLAGS=""
LDFLAGS="-Wl,-z,defs -fstack-protector-all"
