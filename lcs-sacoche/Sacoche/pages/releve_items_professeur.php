...
$TITRE = html(Lang::_("Relevé d'items d'un enseignant"));
?>
...
if($_SESSION['USER_PROFIL_TYPE']=='directeur')
{
  ...
  $tab_profs    = 'Choisir d\'abord un groupe ci-dessus...'; // maj en ajax suivant le choix du groupe
  $of_g = ''; $sel_g = FALSE; $class_form_type = 'show'; $class_form_eleve = 'show'; $class_form_periode = 'hide'; $class_form_prof = 'hide';
...
if($_SESSION['USER_PROFIL_TYPE']=='professeur')
{
  ...
  $tab_profs    = array(0=>array('valeur'=>$_SESSION['USER_ID'],'texte'=>afficher_identite_initiale($_SESSION['USER_NOM'],FALSE,$_SESSION['USER_PRENOM'],TRUE,$_SESSION['USER_GENRE'])));
  $of_g = ''; $sel_g = FALSE; $class_form_type = 'show'; $class_form_eleve = 'show'; $class_form_periode = 'hide'; $class_form_prof = 'hide';
  $select_eleves = '<span id="f_eleve" class="select_multiple"></span><span class="check_multiple"><q class="cocher_tout" title="Tout cocher."></q><br /><q class="cocher_rien" title="Tout décocher."></q></span>'; // maj en ajax suivant le choix du groupe
  $is_select_multiple = 1;
...
if( ($_SESSION['USER_PROFIL_TYPE']=='parent') && ($_SESSION['NB_ENFANTS']!=1) )
{
  ...
  $tab_profs    = 'Choisir d\'abord un groupe ci-dessus...'; // maj en ajax suivant le choix du groupe
  $of_g = ''; $sel_g = FALSE; $class_form_type = 'hide'; $class_form_eleve = 'show'; $class_form_periode = 'hide'; $class_form_prof = 'hide';
...
if( ($_SESSION['USER_PROFIL_TYPE']=='parent') && ($_SESSION['NB_ENFANTS']==1) )
{
  ...
  $of_g = FALSE; $sel_g = TRUE; $class_form_type = 'hide'; $class_form_eleve = 'hide'; $class_form_periode = 'show'; $class_form_prof = 'show';
...
<form action="#" method="post" id="form_select"><fieldset>
  ...
  <p id="zone_profs" class="<?php echo $class_form_prof ?>">
    <label class="tab" for="f_prof">Enseignant :</label><?php echo $select_professeur ?><?php echo $bouton_modifier_profs ?><input type="hidden" id="f_prof_texte" name="f_prof_texte" value="" />
  </p>
  ...
  <div class="toggle hide">
    ...
    <label class="tab">Évaluations :</label><?php echo(in_array($_SESSION['USER_PROFIL_TYPE'],array('parent','eleve'))) ? $select_cases_nb : 'cases' ; ?> cases de largeur <?php echo $select_cases_larg ?>
  </div>
