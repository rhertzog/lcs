...
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
		...
		var ajouter = function()
		{
			...
			new_tr += '<td class="nu"><input id="f_action" name="f_action" type="hidden" value="'+mode+'" /><q class="valider" title="Valider l\'ajout de cette classe."></q><q class="annuler" title="Annuler l\'ajout de cette classe."></q> <label id="ajax_msg">&nbsp;</label></td>';
			new_tr += '</tr>';
		...
		var modifier = function()
		{
			...
			new_tr += '<td><input id="f_ref" name="f_ref" size="'+Math.max(ref.length,3)+'" type="text" value="'+escapeQuote(ref)+'" /></td>';
