...
if( !$orientation || !$couleur || !$legende || !$marge_min || !$pages_nb || ($cases_nb<0) || !$cases_largeur || ( !$periode_id && (!$date_debut || !$date_fin) ) || !$retroactif || !$matiere_id || !$matiere_nom || !$groupe_id || !$groupe_nom || !count($tab_eleve) || !count($tab_type) )
{
