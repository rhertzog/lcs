...
<p>Pour supprimer complètement l'inscription de cet établissement, <?php echo Html::mailto(WEBMESTRE_COURRIEL,'Supprimer inscription SACoche '.$_SESSION['BASE'],'contactez le webmestre'); ?> responsable de <em>SACoche</em> sur ce serveur.</p>
