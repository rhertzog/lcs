...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		(
			function()
			{
				...
				$('#ajax_msg_export').removeAttr("class").addClass("loader").html("Envoi en cours&hellip;");
				$.ajax
				(
					{
						type : 'POST',
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		var supprimer_structures_selectionnees = function(listing_id)
		{
			...
			$('#ajax_supprimer_export').removeAttr("class").addClass("loader").html("Envoi en cours&hellip;");
			$.ajax
			(
				{
					type : 'POST',
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		var supprimer_structures_cochees = function(listing_id)
		{
			$("button").prop('disabled',true);
			// afficher_masquer_images_action('hide');
			$('#ajax_supprimer_import').removeAttr("class").addClass("loader").html("Envoi en cours&hellip;");
			$.ajax
			(
				{
					type : 'POST',
