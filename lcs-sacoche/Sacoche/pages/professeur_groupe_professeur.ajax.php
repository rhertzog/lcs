...
// Ajouter des professeurs à des groupes de besoin ; pas soi-même pour préserver le champ jointure_pp (utilisé ici pour repérer le prof responsable du groupe)
if($action=='ajouter')
{
