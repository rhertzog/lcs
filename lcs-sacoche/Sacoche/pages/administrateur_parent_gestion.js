...
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
		...
		var modifier = function()
		{
			...
			new_tr += '<td><input id="f_reference" name="f_reference" size="10" type="text" value="'+reference+'" /><img alt="" src="./_img/bulle_aide.png" title="Tableur : référence dans l\'établissement." /></td>';
