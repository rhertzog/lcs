...
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
		...
		var modifier = function()
		{
			...
			new_tr += '<td><input id="f_sconet_id" name="f_sconet_id" size="5" type="text" value="'+sconet_id+'" /><img alt="" src="./_img/bulle_aide.png" title="Champ de Sconet PERSONNE.PERSONNE_ID (laisser à 0 si inconnu)." /></td>';
			new_tr += '<td><input id="f_reference" name="f_reference" size="10" type="text" value="'+escapeQuote(reference)+'" /><img alt="" src="./_img/bulle_aide.png" title="Tableur : référence dans l\'établissement." /></td>';
