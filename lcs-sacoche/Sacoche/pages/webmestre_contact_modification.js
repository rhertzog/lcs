    ...
    (
      {
        rules :
        {
          ...
          f_mail    : { required:true},
          f_domaine : { required:function(){return $("#f_mail").val()=='domaine';} , maxlength:75 , domaine:true }
        },
        messages :
        {
          f_user    : { required:"choix manquant" },
          f_mail    : { required:"choix manquant" },
          f_domaine : { required:"domaine manquant" , maxlength:"75 caractères maximum" , domaine:"domaine incorrect" }
        },
        errorElement : "label",
        errorClass : "erreur",
