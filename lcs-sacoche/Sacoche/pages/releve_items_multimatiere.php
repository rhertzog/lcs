...
<form action="#" method="post" id="form_select"><fieldset>
  ...
  <div class="toggle hide">
    ...
    <label class="tab">Évaluations :</label>cases de largeur <?php echo $select_cases_larg ?><br />
