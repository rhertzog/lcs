  ...
  <tbody>
    ...
    if(!empty($DB_TAB))
    {
      foreach($DB_TAB as $DB_ROW)
      {
        ...
        echo  '<td class="label">'.html($DB_ROW['user_profil_sigle']).' <img alt="" src="./_img/bulle_aide.png" title="'.html(html($DB_ROW['user_profil_nom_long_singulier'])).'" /></td>'; // Volontairement 2 html() pour le title sinon &lt;* est pris comme une balise html par l'infobulle.
...
<form action="#" method="post" id="form_gestion" class="hide">
  ...
  <p>
    ...
    <label class="tab" for="f_sconet_id">Id Sconet <img alt="" src="./_img/bulle_aide.png" title="Champ de STS-Web INDIVIDU.ID (laisser vide ou à 0 si inconnu)." /> :</label><input id="f_sconet_id" name="f_sconet_id" type="text" value="" size="15" maxlength="8" /><br />
