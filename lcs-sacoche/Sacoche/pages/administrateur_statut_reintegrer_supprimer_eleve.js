...
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
		...
		(
			function()
			{
				...
				if(id=='supprimer')
				{
					continuer = (confirm("Attention : tous les résultats associés seront perdus !\nConfirmez-vous la suppression irréversible des comptes élèves sélectionnés ?")) ? true : false ;
				}
				else
				{
					continuer = true ;
