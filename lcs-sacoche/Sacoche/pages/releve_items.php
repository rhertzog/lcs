...
<form action="#" method="post" id="form_select"><fieldset>
  ...
  <div class="<?php echo $class_form_type ?> p">
    ...
    <div id="options_individuel" class="<?php echo $class_form_individuel ?>">
      <label class="tab"><img alt="" src="./_img/bulle_aide.png" width="16" height="16" title="Pour le relévé individuel, une colonne et deux lignes de synthèse peuvent être ajoutées.<br />Dans ce cas, une note sur 20 peut aussi être affichée." /> Opt. relevé :</label><?php echo $select_individuel_format ?> avec <?php echo $select_cases_nb ?> d'évaluation<br />
