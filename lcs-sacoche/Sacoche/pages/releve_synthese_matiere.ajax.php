...
if( $matiere_id && $matiere_nom && $groupe_id && $groupe_nom && count($tab_eleve) && ( $periode_id || ($date_debut && $date_fin) ) && $retroactif && $mode_synthese && $couleur )
{
	...
	list($tab_item,$tab_synthese) = DB_STRUCTURE_recuperer_arborescence_synthese($liste_eleve,$matiere_id,$only_socle,$only_niveau,$mode_synthese,$date_mysql_debut,$date_mysql_fin);
