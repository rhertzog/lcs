...
if(isset($_POST['lancer_test']))
{
  ...
  echo'<pre class="g">BD_HOST : '.SACOCHE_WEBMESTRE_BD_HOST.'</pre>';
  echo'<pre class="g">BD_PORT : '.SACOCHE_WEBMESTRE_BD_PORT.'</pre>';
  echo'<pre class="g">BD_NAME : '.SACOCHE_WEBMESTRE_BD_NAME.'</pre>';
  echo'<pre class="g">BD_USER : '.SACOCHE_WEBMESTRE_BD_USER.'</pre>';
  echo'<pre class="g">BD_PASS : '.'--masqué--'.'</pre>';

  echo'<h2>1.2 Paramètres de connexion établissement</h2>';
  echo'<pre class="g">BD_HOST : '.SACOCHE_STRUCTURE_BD_HOST.'</pre>';
  echo'<pre class="g">BD_PORT : '.SACOCHE_STRUCTURE_BD_PORT.'</pre>';
  echo'<pre class="g">BD_NAME : '.SACOCHE_STRUCTURE_BD_NAME.' (pour ce test uniquement)</pre>';
  echo'<pre class="g">BD_USER : '.SACOCHE_STRUCTURE_BD_USER.' (pour ce test uniquement)</pre>';
  echo'<pre class="g">BD_PASS : '.SACOCHE_STRUCTURE_BD_PASS.' (pour ce test uniquement)</pre>';

  echo'<hr />';

  echo'<h2>2.1 Se connecter à mysql comme webmestre</h2>';
  echo'<pre class="g">mysql_connect('.SACOCHE_WEBMESTRE_BD_HOST.':'.SACOCHE_WEBMESTRE_BD_PORT.','.SACOCHE_WEBMESTRE_BD_USER.','.'--masqué--'.')</pre>';
  ...
  echo'<pre class="g">mysql_close()</pre>';
  ...
  echo'<pre class="g">mysql_connect('.SACOCHE_STRUCTURE_BD_HOST.':'.SACOCHE_STRUCTURE_BD_PORT.','.SACOCHE_STRUCTURE_BD_USER.','.SACOCHE_STRUCTURE_BD_PASS.')</pre>';
  ...
  echo'<pre class="g">mysql_select_db()</pre>';
