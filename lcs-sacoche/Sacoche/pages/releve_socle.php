...
elseif($_SESSION['USER_PROFIL']=='eleve')
{
	...
	$socle_PA = (mb_substr_count($_SESSION['ELEVE_OPTIONS'],'SoclePourcentageAcquis')) ? $socle_PA : '<del>Pourcentage d\'items acquis</del>' ;
	$socle_EV = (mb_substr_count($_SESSION['ELEVE_OPTIONS'],'SocleEtatValidation'))    ? $socle_EV : '<del>États de validation</del>' ;
}
