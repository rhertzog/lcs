...
<ul class="puce">
	...
	<li><span class="astuce">Pour un traitement individuel, on peut aussi utiliser la page "<a href="./index.php?page=administrateur_professeur&amp;section=gestion">Gérer les professeurs</a>" ou "<a href="./index.php?page=administrateur_directeur">Gérer les directeurs</a>".</span></li>
</ul>
