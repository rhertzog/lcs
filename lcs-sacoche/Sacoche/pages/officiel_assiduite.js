...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		function verifier_fichier(fichier_nom,fichier_extension)
		{
			...
			else
			{
				...
				$('#ajax_msg_import').removeAttr("class").addClass("loader").html("Envoi en cours&hellip;");
				return true;
			}
		}
		...
		('click',
			function()
			{
				$('#ajax_msg_confirm').removeAttr("class").addClass("loader").html("Envoi en cours&hellip;");
				$.ajax
				(
					{
						type : 'POST',
    ...
    formulaire.submit
		...
		function test_form_avant_envoi(formData, jqForm, options)
		{
			...
			{
				$('button').prop('disabled',true);
				$('#ajax_msg_manuel').removeAttr("class").addClass("loader").html("Envoi en cours&hellip;");
			}
			return readytogo;
		}
