...
$select_type = ($_SESSION['USER_PROFIL']!='administrateur')
             ...
             : '<option value="infos_eleves">informations élèves</option><option value="infos_parents">informations responsables légaux</option><option value="infos_professeurs">informations professeurs</option>'
             ;
?>
