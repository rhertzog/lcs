...
//	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-	-
		...
		/**
		 * Ajouter un professeur : mise en place du formulaire
		 * @return void
		 */
		var ajouter = function()
		{
			...
			new_tr += '<td class="nu"><input id="f_action" name="f_action" type="hidden" value="'+mode+'" /><q class="valider" title="Valider l\'ajout de ce professeur."></q><q class="annuler" title="Annuler l\'ajout de ce professeur."></q> <label id="ajax_msg">&nbsp;</label></td>';
			new_tr += '</tr>';
		...
		/**
		 * Modifier un professeur : mise en place du formulaire
		 * @return void
		 */
		var modifier = function()
		{
			...
			new_tr += '<td><input id="f_reference" name="f_reference" size="10" type="text" value="'+escapeQuote(reference)+'" /><img alt="" src="./_img/bulle_aide.png" title="Sconet : champ inutilisé (laisser vide).<br />Tableur : référence dans l\'établissement." /></td>';
			...
			new_tr += '<td class="nu"><input id="f_action" name="f_action" type="hidden" value="'+mode+'" /><input id="f_id" name="f_id" type="hidden" value="'+id+'" /><q class="valider" title="Valider les modifications de ce professeur."></q><q class="annuler" title="Annuler les modifications de ce professeur."></q> <label id="ajax_msg">&nbsp;</label></td>';
			new_tr += '</tr>';
		...
		/**
		 * Désactiver un professeur : mise en place du formulaire
		 * @return void
		 */
		var supprimer = function()
		{
			...
			afficher_masquer_images_action('hide');
			id = $(this).parent().parent().attr('id').substring(3);
			new_span  = '<span class="astuce"><input id="f_action" name="f_action" type="hidden" value="'+mode+'" /><input id="f_id" name="f_id" type="hidden" value="'+id+'" />Le compte du professeur sera désactivé.<q class="valider" title="Confirmer le retrait de ce professeur."></q><q class="annuler" title="Annuler le retrait de ce professeur."></q> <label id="ajax_msg">&nbsp;</label></span>';
			$(this).after(new_span);
			infobulle();
		};
