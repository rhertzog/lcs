...
(  53, 14,  1, "Lire seul des textes du patrimoine et des œuvres intégrales de la littérature de jeunesse, adaptés à son âge."),
...
( 105, 26,  0, "Utiliser des instruments de mesure."),
...
( 123, 30,  0, "Mobiliser ses connaissances pour comprendre quelques questions liées à l’environnement et au développement durable et agir en conséquence."),
( 124, 31,  0, "Connaitre et maîtriser les fonctions de base d’un ordinateur et de ses périphériques."),
...
( 137, 37,  0, "Lire des œuvres majeures du patrimoine et de la littérature pour la jeunesse."),
( 138, 37,  1, "Établir des liens entre les textes lus."),
( 132, 73,  0, "Lire et utiliser textes, cartes, croquis, graphiques."),
...
( 140, 38,  1, "Reconnaître et décrire des œuvres préalablement étudiées."),
...
( 143, 38,  4, "Inventer et réaliser des textes, des œuvres plastiques, des chorégraphies ou des enchaînements, à visée artistique ou expressive."),
...
( 147, 40,  0, "Respecter les règles de la vie collective."),
...
( 150, 41,  1, "Être persévérant dans toutes les activités."),
( 151, 41,  2, "Commencer à savoir s’autoévaluer dans des situations simples."),
...
( 157, 44,  0, "Adapter son mode de lecture à la nature du texte proposé et à l’objectif poursuivi."),
( 282, 44,  1, "Repérer les informations dans un texte à partir des éléments explicites et des éléments implicites nécessaires."),
( 158, 44,  2, "Utiliser ses capacités de raisonnement, ses connaissances sur la langue, savoir faire appel à des outils appropriés pour lire."),
( 159, 44,  3, "Dégager, par écrit ou oralement, l’essentiel d’un texte lu."),
( 160, 44,  4, "Manifester, par des moyens divers, sa compréhension de textes variés."),
( 163, 45,  0, "Reproduire un document sans erreur et avec une présentation adaptée."),
( 164, 45,  1, "Écrire lisiblement un texte, spontanément ou sous la dictée, en respectant l’orthographe et la grammaire."),
( 166, 45,  2, "Rédiger un texte bref, cohérent et ponctué, en réponse à une question ou à partir de consignes données."),
( 167, 45,  3, "Utiliser ses capacités de raisonnement, ses connaissances sur la langue, savoir faire appel à des outils variés pour améliorer son texte."),
( 283, 46,  0, "Formuler clairement un propos simple."),
( 170, 46,  1, "Développer de façon suivie un propos en public sur un sujet déterminé."),
( 171, 46,  2, "Adapter sa prise de parole à la situation de communication."),
( 172, 46,  3, "Participer à un débat, à un échange verbal."),
( 177, 48,  0, "Établir un contact social."),
...
( 190, 52,  2, "Écrire un message simple."),
( 191, 52,  3, "Rendre compte de faits."),
( 192, 52,  4, "Écrire un court récit, une description."),
...
( 197, 54,  0, "Organisation et gestion de données : reconnaître des situations de proportionnalité, utiliser des pourcentages, des tableaux, des graphiques ; exploiter des données statistiques et aborder des situations simples de probabilité."),
( 202, 54,  1, "Nombres et calculs : connaître et utiliser les nombres entiers, décimaux et fractionnaires ; mener à bien un calcul mental, à la main, à la calculatrice, avec un ordinateur."),
( 205, 54,  2, "Géométrie : connaître et représenter des figures géométriques et des objets de l’espace ; utiliser leurs propriétés."),
( 208, 54,  3, "Grandeurs et mesures : réaliser des mesures (longueurs, durées, …), calculer des valeurs (volumes, vitesses, …) en utilisant différentes unités."),
...
( 212, 55,  2, "Le vivant : unité d’organisation et diversité ; fonctionnement des organismes vivants, évolution des espèces, organisation et fonctionnement du corps humain."),
...
( 214, 55,  4, "Les objets techniques : analyse, conception et réalisation ; fonctionnement et conditions d’utilisation."),
( 215, 56,  0, "Mobiliser ses connaissances pour comprendre des questions liées à l’environnement et au développement durable."),
( 218, 57,  0, "Utiliser, gérer des espaces de stockage à disposition."),
( 220, 57,  1, "Utiliser les périphériques à disposition."),
( 216, 57,  2, "Utiliser les logiciels et les services à disposition."),
( 222, 58,  0, "Connaître et respecter les règles élémentaires du droit relatif à sa pratique."),
( 223, 58,  1, "Protéger sa personne et ses données."),
( 225, 58,  2, "Faire preuve d’esprit critique face à l’information et à son traitement."),
( 228, 58,  3, "Participer à des travaux collaboratifs en connaissant les enjeux et en respectant les règles."),
( 229, 59,  0, "Saisir et mettre en page un texte."),
( 235, 59,  1, "Traiter une image, un son ou une vidéo."),
( 231, 59,  2, "Organiser la composition du document, prévoir sa présentation en fonction de sa destination."),
( 234, 59,  3, "Différencier une situation simulée ou modélisée d’une situation réelle."),
( 236, 60,  0, "Consulter des bases de données documentaires en mode simple (plein texte)."),
( 239, 60,  1, "Identifier, trier et évaluer des ressources."),
( 238, 60,  2, "Chercher et sélectionner l’information demandée."),
( 243, 61,  0, "Écrire, envoyer, diffuser, publier."),
( 242, 61,  1, "Recevoir un commentaire, un message y compris avec pièces jointes."),
( 284, 61,  2, "Exploiter les spécificités des différentes situations de communication en temps réel ou différé."),
( 245, 62,  0, "Relevant de l’espace : les grands ensembles physiques et humains et les grands types d’aménagements dans le monde, les principales caractéristiques géographiques de la France et de l’Europe."),
( 249, 62,  1, "Relevant du temps : les différentes périodes de l’histoire de l’humanité ; les grands traits de l’histoire (politique, sociale, économique, littéraire, artistique, culturelle) de la France et de l’Europe."),
( 251, 62,  2, "Relevant de la culture littéraire : œuvres littéraires du patrimoine."),
( 252, 62,  3, "Relevant de la culture artistique : œuvres picturales, musicales, scéniques, architecturales ou cinématographiques du patrimoine."),
( 285, 62,  4, "Relevant de la culture civique : droits de l’Homme ; formes d’organisation politique, économique et sociale dans l’Union européenne ; place et rôle de l’État en France ; mondialisation ; développement durable."),
( 286, 67,  0, "Situer des événements, des œuvres littéraires ou artistiques, des découvertes scientifiques ou techniques, des ensembles géographiques."),
( 256, 67,  1, "Identifier la diversité des civilisations, des langues, des sociétés, des religions."),
( 287, 67,  2, "Établir des liens entre les œuvres (littéraires, artistiques) pour mieux les comprendre."),
( 259, 67,  3, "Mobiliser ses connaissances pour donner du sens à l’actualité."),
( 255, 66,  0, "Lire et employer différents langages : textes – graphiques – cartes – images – musique."),
( 293, 66,  1, "Connaître et pratiquer diverses formes d’expression à visée littéraire."),
( 254, 66,  2, "Connaître et pratiquer diverses formes d’expression à visée artistique."),
( 288, 74,  0, "Être sensible aux enjeux esthétiques et humains d’un texte littéraire."),
( 289, 74,  1, "Être sensible aux enjeux esthétiques et humains d’une œuvre artistique."),
( 290, 74,  2, "Être capable de porter un regard critique sur un fait, un document, une œuvre."),
( 291, 74,  3, "Manifester sa curiosité pour l’actualité et pour les activités culturelles ou artistiques."),
( 260, 68,  0, "Principaux droits de l’Homme et du citoyen."),
( 261, 68,  1, "Valeurs, symboles, institutions de la République."),
( 262, 68,  2, "Règles fondamentales de la démocratie et de la justice."),
( 263, 68,  3, "Grandes institutions de l’Union européenne et rôle des grands organismes internationaux."),
( 264, 68,  4, "Rôle de la défense nationale."),
...
( 273, 70,  1, "Connaître les parcours de formation correspondant à ces métiers et les possibilités de s’y intégrer."),
( 292, 70,  2, "Savoir s’autoévaluer et être capable de décrire ses intérêts, ses compétences et ses acquis."),
( 274, 71,  0, "Être autonome dans son travail : savoir l’organiser, le planifier, l’anticiper, rechercher et sélectionner des informations utiles."),
( 275, 71,  1, "Identifier ses points forts et ses points faibles dans des situations variées."),
( 277, 71,  2, "Mobiliser à bon escient ses capacités motrices dans le cadre d’une pratique physique (sportive ou artistique) adaptée à son potentiel."),
( 276, 71,  3, "Savoir nager."),
( 278, 72,  0, "S’engager dans un projet individuel."),
( 279, 72,  1, "S’intégrer et coopérer dans un projet collectif."),
( 280, 72,  2, "Manifester curiosité, créativité, motivation à travers des activités conduites ou reconnues par l’établissement."),
( 281, 72,  3, "Assumer des rôles, prendre des initiatives et des décisions.");
