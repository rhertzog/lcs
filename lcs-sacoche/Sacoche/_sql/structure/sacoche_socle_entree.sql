...
( 3111 ,  1,  0, "S’exprimer clairement à l’oral en utilisant un vocabulaire approprié."),
( 3112 ,  1,  1, "Participer en classe à un échange verbal en respectant les règles de la communication."),
( 3113 ,  1,  2, "Dire de mémoire quelques textes en prose ou poèmes courts."),
( 3121 ,  2,  0, "Lire seul, à haute voix, un texte comprenant des mots connus et inconnus."),
( 3122 ,  2,  1, "Lire seul et écouter lire des textes du patrimoine et des œuvres intégrales de la littérature de jeunesse adaptés à son âge."),
( 3123 ,  2,  2, "Lire seul et comprendre un énoncé, une consigne simple."),
( 3124 ,  2,  3, "Dégager le thème d’un paragraphe ou d’un texte court."),
( 3125 ,  2,  4, "Lire silencieusement un texte en déchiffrant les mots inconnus et manifester sa compréhension dans un résumé, une reformulation, des réponses à des questions."),
( 3131 ,  3,  0, "Copier un texte court sans erreur dans une écriture cursive lisible et avec une présentation soignée."),
( 3132 ,  3,  1, "Utiliser ses connaissances pour mieux écrire un texte court."),
( 3133 ,  3,  2, "Écrire de manière autonome un texte de cinq à dix lignes."),
( 3141 ,  4,  0, "Utiliser des mots précis pour s’exprimer."),
( 3142 ,  4,  1, "Donner des synonymes."),
( 3143 ,  4,  2, "Trouver un mot de sens opposé."),
( 3144 ,  4,  3, "Regrouper des mots par familles."),
( 3145 ,  4,  4, "Commencer à utiliser l’ordre alphabétique."),
( 3151 ,  5,  0, "Identifier la phrase, le verbe, le nom, l’article, l’adjectif qualificatif, le pronom personnel (sujet)."),
( 3152 ,  5,  1, "Repérer le verbe d’une phrase et son sujet."),
( 3153 ,  5,  2, "Conjuguer les verbes du 1er groupe, être et avoir, au présent, au futur, au passé composé de l’indicatif ; conjuguer les verbes faire, aller, dire, venir, au présent de l’indicatif."),
( 3154 ,  5,  3, "Distinguer le présent du futur et du passé."),
( 3161 ,  6,  0, "Écrire en respectant les correspondances entre lettres et sons et les règles relatives à la valeur des lettres."),
( 3162 ,  6,  1, "Écrire sans erreur des mots mémorisés."),
( 3163 ,  6,  2, "Orthographier correctement des formes conjuguées, respecter l’accord entre le sujet et le verbe, ainsi que les accords en genre et en nombre dans le groupe nominal."),
( 3311 ,  7,  0, "Écrire, nommer, comparer, ranger les nombres entiers naturels inférieurs à 1000."),
( 3312 ,  7,  1, "Résoudre des problèmes de dénombrement."),
( 3313 ,  7,  2, "Calculer : addition, soustraction, multiplication."),
( 3314 ,  7,  3, "Diviser par 2 et par 5 dans le cas où le quotient exact est entier."),
( 3315 ,  7,  4, "Restituer et utiliser les tables d’addition et de multiplication par 2, 3, 4 et 5."),
( 3316 ,  7,  5, "Calculer mentalement en utilisant des additions, des soustractions et des multiplications simples."),
( 3317 ,  7,  6, "Résoudre des problèmes relevant de l’addition, de la soustraction et de la multiplication."),
( 3318 ,  7,  7, "Utiliser les fonctions de base de la calculatrice."),
( 3321 ,  8,  0, "Situer un objet par rapport à soi ou à un autre objet, donner sa position et décrire son déplacement."),
( 3322 ,  8,  1, "Reconnaître, nommer et décrire les figures planes et les solides usuels."),
( 3323 ,  8,  2, "Utiliser la règle et l’équerre pour tracer avec soin et précision un carré, un rectangle, un triangle rectangle."),
( 3324 ,  8,  3, "Percevoir et reconnaître quelques relations et propriétés géométriques : alignement, angle droit, axe de symétrie, égalité de longueurs."),
( 3325 ,  8,  4, "Repérer des cases, des nœuds d’un quadrillage."),
( 3326 ,  8,  5, "Résoudre un problème géométrique."),
( 3331 ,  9,  0, "Utiliser les unités usuelles de mesure ; estimer une mesure."),
( 3332 ,  9,  1, "Être précis et soigneux dans les mesures et les calculs."),
( 3333 ,  9,  2, "Résoudre des problèmes de longueur et de masse."),
( 3341 , 10,  0, "Utiliser un tableau, un graphique."),
( 3342 , 10,  1, "Organiser les données d’un énoncé."),
( 3611 , 11,  0, "Reconnaître les emblèmes et les symboles de la République française."),
( 3621 , 12,  0, "Respecter les autres et les règles de la vie collective."),
( 3622 , 12,  1, "Pratiquer un jeu ou un sport collectif en en respectant les règles."),
( 3623 , 12,  2, "Appliquer les codes de la politesse dans ses relations avec ses camarades, avec les adultes de l’école et hors de l’école, avec le maître au sein de la classe.");
