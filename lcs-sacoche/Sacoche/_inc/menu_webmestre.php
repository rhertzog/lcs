...
(
  ...
  (
    ...
    "Coordonnées contact référent"      => array( 'class' => 'mail'                 , 'href' => 'page=webmestre_contact_modification'     ), // multi-structures uniquement
...
{
  unset(
    $tab_menu["Administration du site"]["Coordonnées contact référent"] ,
