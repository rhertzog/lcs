...
(
  ...
  'Berthelot'    => array( 'nom'=>'Berthelot'     , 'RR' =>'NA' , 'R' =>'EC' , 'V' =>'V'  , 'VV' =>'M'  ),
  'Blaye'        => array( 'nom'=>'Blaye'         , 'RR' =>'NA' , 'R' =>'VA' , 'V' =>'AR' , 'VV' =>'A'  ),
  'Brassens'     => array( 'nom'=>'Brassens'      , 'RR' =>'--' , 'R' =>'~-' , 'V' =>'+~' , 'VV' =>'++'  ),
  'Brel'         => array( 'nom'=>'Brel'          , 'RR' =>'NR' , 'R' =>'PR' , 'V' =>'R'  , 'VV' =>'M'  ),
  ...
  'Koeberle'     => array( 'nom'=>'Koeberlé'      , 'RR' =>'NM' , 'R' =>'MI' , 'V' =>'MS' , 'VV' =>'Ex' ),
  'LaFontaine'   => array( 'nom'=>'La Fontaine'   , 'RR' =>'NA' , 'R' =>'ECA', 'V' =>'PA' , 'VV' =>'A'  ),
  'Langevin'     => array( 'nom'=>'Langevin'      , 'RR' =>'N1' , 'R' =>'N2' , 'V' =>'N3' , 'VV' =>'N4' ),
  ...
  'SaintExupery' => array( 'nom'=>'Saint-Exupéry' , 'RR' =>'NA' , 'R' =>'ECA', 'V' =>'AR' , 'VV' =>'A'  ),
