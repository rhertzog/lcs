...
$tab_connexion_info['cas']['ent_04']           = array( 'etat'=>0 , 'societe'=>'Itslearning'     , 'serveur_host'=>'cas.cg04.fr'             , 'serveur_port'=>443  , 'serveur_root'=>'cas-ent04'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>3 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Alpes de Haute-Provence (04)." );
$tab_connexion_info['cas']['ent_alsace']       = array( 'etat'=>1 , 'societe'=>'Itslearning'     , 'serveur_host'=>'cas.scolastance.com'     , 'serveur_port'=>443  , 'serveur_root'=>'cas-alsace'     , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>3 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Alsace (académie de Strasbourg)." );
...
$tab_connexion_info['cas']['ent_auvergne']     = array( 'etat'=>0 , 'societe'=>'Itslearning'     , 'serveur_host'=>'cas.scolastance.com'     , 'serveur_port'=>443  , 'serveur_root'=>'cas-auvergne'   , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>3 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Auvergne (académie de Clermond-Ferrand)." );
...
$tab_connexion_info['cas']['celia']            = array( 'etat'=>1 , 'societe'=>'DSI IDF'         , 'serveur_host'=>'www.ent-celia.fr'        , 'serveur_port'=>443  , 'serveur_root'=>'connexion'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>5 , 'csv_prenom'=>6 , 'csv_id_ent'=>3 , 'csv_id_sconet'=>4    , 'txt'=>"ENT Celi@ (collèges de Seine-Saint-Denis)." );
...
$tab_connexion_info['cas']['ent_52']           = array( 'etat'=>0 , 'societe'=>'Itslearning'     , 'serveur_host'=>'cas.scolastance.com'     , 'serveur_port'=>443  , 'serveur_root'=>'cas-hautemarne' , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>3 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT de Haute-Marne (52)." );
...
$tab_connexion_info['cas']['lilie']            = array( 'etat'=>1 , 'societe'=>'DSI IDF'         , 'serveur_host'=>'ent.iledefrance.fr'      , 'serveur_port'=>443  , 'serveur_root'=>'connexion'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>5 , 'csv_prenom'=>6 , 'csv_id_ent'=>3 , 'csv_id_sconet'=>4    , 'txt'=>"ENT Lilie (lycées d'Ile de France)." );
...
$tab_connexion_info['cas']['ent_90']           = array( 'etat'=>0 , 'societe'=>'Itslearning'     , 'serveur_host'=>'cas.scolastance.com'     , 'serveur_port'=>443  , 'serveur_root'=>'cas-ent90'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>3 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Territoire de Belfort (90)." );
