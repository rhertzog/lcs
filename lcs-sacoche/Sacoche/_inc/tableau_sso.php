...
$tab_connexion_info['cas']['ent_04']           = array( 'etat'=>0 , 'societe'=>'Itslearning'        , 'serveur_host'=>'cas.cg04.fr'             , 'serveur_port'=>443  , 'serveur_root'=>'cas-ent04'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Alpes de Haute-Provence (département 04)." );
...
$tab_connexion_info['cas']['ent_alsace']       = array( 'etat'=>0 , 'societe'=>'Itslearning'        , 'serveur_host'=>'cas.scolastance.com'     , 'serveur_port'=>443  , 'serveur_root'=>'cas-alsace'     , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Alsace (académie de Strasbourg)." );
...
$tab_connexion_info['cas']['celia']            = array( 'etat'=>1 , 'societe'=>'Logica'             , 'serveur_host'=>'www.ent-celia.fr'        , 'serveur_port'=>443  , 'serveur_root'=>'connexion'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>5 , 'csv_prenom'=>6 , 'csv_id_ent'=>3 , 'csv_id_sconet'=>4    , 'txt'=>"ENT Celi@ (collèges Seine-Saint-Denis 93)." );
...
$tab_connexion_info['cas']['elie']             = array( 'etat'=>1 , 'societe'=>'Logica'             , 'serveur_host'=>'ent.limousin.fr'         , 'serveur_port'=>443  , 'serveur_root'=>'connexion'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>5 , 'csv_prenom'=>6 , 'csv_id_ent'=>3 , 'csv_id_sconet'=>4    , 'txt'=>"ENT Elie (lycées du Limousin et collèges de la Creuse 23)." );
...
$tab_connexion_info['cas']['ent_52']           = array( 'etat'=>0 , 'societe'=>'Itslearning'        , 'serveur_host'=>'cas.scolastance.com'     , 'serveur_port'=>443  , 'serveur_root'=>'cas-hautemarne' , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Haute-Marne (département 52)." );
...
$tab_connexion_info['cas']['place']            = array( 'etat'=>0 , 'societe'=>'iTOP / Atos'        , 'serveur_host'=>'www.placedulycee.fr'     , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Place (Lorraine - départements 54 55)." );
...
$tab_connexion_info['cas']['ent_90']           = array( 'etat'=>0 , 'societe'=>'Itslearning'        , 'serveur_host'=>'cas.scolastance.com'     , 'serveur_port'=>443  , 'serveur_root'=>'cas-ent90'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Territoire de Belfort (département 90)." );
