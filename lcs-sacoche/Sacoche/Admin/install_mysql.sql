...
--
-- Client: localhost
-- Généré le: Jeu 31 Mai 2012 à 14:30
...
INSERT INTO `sacoche_matiere` (`matiere_id`, `matiere_active`, `matiere_usuelle`, `matiere_famille_id`, `matiere_nb_demandes`, `matiere_ordre`, `matiere_ref`, `matiere_nom`) VALUES
...
CREATE TABLE IF NOT EXISTS `sacoche_message` (
  ...
  `message_contenu` tinytext COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `sacoche_niveau` (`niveau_id`, `niveau_actif`, `niveau_famille_id`, `niveau_ordre`, `niveau_ref`, `code_mef`, `niveau_nom`) VALUES
...
('version_base', '2012-05-21'),
('sesamath_id', '0'),
('sesamath_uai', ''),
('sesamath_type_nom', ''),
('sesamath_key', ''),
('webmestre_uai', ''),
('webmestre_denomination', 'à changer'),
('etablissement_denomination', 'à changer'),
...
--
-- Structure de la table `sacoche_signature`
--

CREATE TABLE IF NOT EXISTS `sacoche_signature` (
...
INSERT INTO `sacoche_user` (`user_id`, `user_sconet_id`, `user_sconet_elenoet`, `user_reference`, `user_profil`, `user_nom`, `user_prenom`, `user_login`, `user_password`, `user_daltonisme`, `user_tentative_date`, `user_connexion_date`, `user_sortie_date`, `eleve_classe_id`, `eleve_langue`, `user_id_ent`, `user_id_gepi`) VALUES
(1, 0, 0, '', 'administrateur', 'XDX', 'Xdxdx', 'admin', '#passadmin#', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '9999-12-31', 0, 100, 'admin', '');
