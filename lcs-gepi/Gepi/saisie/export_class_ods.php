...
if(getSettingValue("export_cn_ods")!='y') {
    die("L'export ODS n'est pas activÈ.");
}
...
// On teste si le professeur est bien associÈ au groupe
if($_SESSION['statut']!='secours') {
	$sql="SELECT 1=1 FROM j_groupes_professeurs WHERE login='".$_SESSION['login']."' AND id_groupe='$id_groupe'";
	$res_test=mysql_query($sql);
	if (mysql_num_rows($res_test)==0) {
		$mess=rawurlencode("Vous tentez d'accÈder ‡ des donnÈes qui ne vous appartiennent pas !");
...
//**************** EN-TETE *****************
$titre_page = "Export des notes/apprÈciations";
...
// GÈnÈration d'un fichier tableur ODS
	...
	while($lig_ele=mysql_fetch_object($res_ele)){
		...
		if(mysql_num_rows($res_note)){
			...
			if($lig_note->statut==''){
				...
				// ATTENTION: Il va falloir vÈrifier qu'‡ l'import on gËre bien 13.5 et 13,5
			}
			else{
		...
		if(mysql_num_rows($res_appreciation)){
			...
			// Il va falloir contrÙler si certaines saisies ne font pas de blagues...
			/*
			// Les \n sont acceptÈs et correctement traitÈs dans OOo, mais par contre, ‡ l'export, cela donne:
...
//$ecriture=fwrite($fichier_tmp_xml,'<table:table table:name="Infos" table:style-name="ta1" table:print="false"><table:table-column table:style-name="co2" table:default-cell-style-name="Default"/><table:table-column table:style-name="co4" table:default-cell-style-name="Default"/><table:table-row table:style-name="ro3"><table:table-cell table:number-columns-repeated="2"/></table:table-row><table:table-row table:style-name="ro4"><table:table-cell/><table:table-cell table:style-name="ce7" office:value-type="string"><text:p>Vous devez saisir les appr√©ciations sur une seule ligne (dans une seule cellule) et ne pas y saisir de point-virgule. Ce qui suit le point-virgule ne serait pas √©valu√© lors de l&apos;export CSV.</text:p></table:table-cell></table:table-row></table:table></office:spreadsheet></office:body></office:document-content>');

$ecriture=fwrite($fichier_tmp_xml,'<table:table table:name="Infos" table:style-name="ta1" table:print="false"><table:table-column table:style-name="co4" table:default-cell-style-name="Default"/><table:table-column table:style-name="co5" table:default-cell-style-name="ce11"/><table:table-row table:style-name="ro4"><table:table-cell table:style-name="ce9" office:value-type="string"><text:p>INFORMATIONS</text:p></table:table-cell><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro3"><table:table-cell/><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro5"><table:table-cell table:style-name="ce10" office:value-type="string"><text:p>Vous devez saisir les appr√©ciations sur une seule ligne (dans une seule cellule) et ne pas y saisir de point-virgule. Ce qui suit le point-virgule ne serait pas √©valu√© lors de l&apos;export CSV.</text:p></table:table-cell><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro6"><table:table-cell table:style-name="ce11"/><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro7"><table:table-cell table:style-name="ce11" office:value-type="string"><text:p>Lors de la g√©n√©ration de l&apos;export CSV, les points-virgules sont remplac√©s par des cha√Ænes de caract√®res __POINT-VIRGULE__, d&apos;autres caract√®res susceptibles de causer des soucis sont √©galement recherch√©s et trait√©s.</text:p></table:table-cell><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro5"><table:table-cell table:style-name="ce11" office:value-type="string"><text:p>L&apos;absence de ces caract√®res peut provoquer des affichages sans cons√©quences (¬´¬†Terme recherch√© introuvable¬†¬ª). C&apos;est normal et sans cons√©quences, contentez-vous de cliquer sur OK.</text:p></table:table-cell><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro3"><table:table-cell table:style-name="ce11"/><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro5"><table:table-cell table:style-name="ce11" office:value-type="string"><text:p>Lors de la g√©n√©ration de l&apos;export CSV, le feuillet Note_App est enregistr√© au format CSV. Cela provoque un avertissement comme quoi seul ce feuillet est enregistr√© dans le CSV. C&apos;est normal.</text:p></table:table-cell><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro4"><table:table-cell table:style-name="ce11" office:value-type="string"><text:p>Pour finir, le fichier ODS est r√©enregistr√© si bien que toutes les informations sont conserv√©es.</text:p></table:table-cell><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro3"><table:table-cell table:style-name="ce11"/><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro4"><table:table-cell table:style-name="ce9" office:value-type="string"><text:p>MACROS</text:p></table:table-cell><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro3"><table:table-cell table:style-name="ce11"/><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro5"><table:table-cell table:style-name="ce11" office:value-type="string"><text:p>Il se peut que vous ayez droit √† un avertissement concernant la pr√©sence de macros dans ce fichier. C&apos;est normal. Ces macros servent √† g√©n√©rer le fichier CSV.</text:p></table:table-cell><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro3"><table:table-cell table:style-name="ce11"/><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro7"><table:table-cell table:style-name="ce11" office:value-type="string"><text:p>Il peut aussi arriver que vous ne puissiez pas utiliser ces macros parce que le niveau de s√©curit√© d&apos;OpenOffice serait trop √©lev√©. Vous pouvez alors ajuster le niveau de s√©curit√© dans le menu Outils/Options/OpenOffice.org/S√©curit√©/S√©curit√© des macros</text:p></table:table-cell><table:table-cell table:style-name="Default"/></table:table-row><table:table-row table:style-name="ro3" table:number-rows-repeated="65520"><table:table-cell table:number-columns-repeated="2"/></table:table-row><table:table-row table:style-name="ro3"><table:table-cell table:number-columns-repeated="2"/></table:table-row></table:table></office:spreadsheet></office:body></office:document-content>');
