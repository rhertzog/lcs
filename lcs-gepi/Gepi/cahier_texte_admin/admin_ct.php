<?php
/*
 * @version: $Id: admin_ct.php 3384 2009-09-06 21:58:06Z jjacquard $
 *
...
if (!(isset($_GET['action']))) {
  ...
  <td><b><a href='admin_ct.php?order_by=ct.id_login,jc.id_classe,jm.id_matiere'>Propriétaire</a></b></td>
  <td><b>Nombre<br />de notices</b></td>
  <td><b>Nombre<br />de notices<br />"devoirs"</b></td>
  <td><b>Action</b></td><td><b><input type="submit" name="sup_ct" value="Suppression" onclick="return confirmlink(this, 'La suppression d\'un cahier de texte est définitive. Les notices ainsi que les documents joints seront supprimés. Etes-vous sûr de vouloir continuer ?', 'Confirmation de la suppression')" /></b></td></tr>
