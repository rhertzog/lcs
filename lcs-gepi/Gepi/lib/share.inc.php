...
function test_maj() {
    ...
    # On vÈrifie que les numÈros de version sont bien sur le mÍme
    # nombre de numÈros. Si ce n'est pas le cas, alors on complËte
    # avec des zÈros pour Ítre s˚rs que la comparaison est fiable.
