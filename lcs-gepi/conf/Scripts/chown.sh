...
chmod  770 documents documents/archives images images/background photos backup artichow/cache mod_ooo/tmp lib/standalone/HTMLPurifier/DefinitionCache/Serializer 
chmod -R 770 temp mod_ooo/mes_modeles 
cd $CHEMIN 
