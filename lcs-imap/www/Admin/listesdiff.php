...
if (is_admin("system_is_admin",$login)=="Y") {
	...
	echo "<input type=\"hidden\" name=\"valideffliste\" value=\"true\">
        ...
        echo "<u onmouseover=\"return escape('<strong>Désactivation des listes de  diffusion <em>LDAP</em></strong> : Désactive les listes de diffusion <em>LDAP</em>, les utilisateurs <em>LCS</em>, ne pourront plus poster des messages à des groupes.')\"><img src='../images/help-info.gif'></u>\n";
    }
	...
	echo "<input type=\"hidden\" name=\"valideaddliste\" value=\"true\">
        ...
        echo "<u onmouseover=\"return escape('<strong>Mise en place des listes de diffusion <em>LDAP</em></strong> : Les listes de diffusion <strong><em>LDAP</em></strong> permettent à un utilisateur de poster un mail à l\'ensemble des membres d\'un groupe. <br /><u>Exemple</u> : Il existe dans l\'annuaire un groupe <strong>Classe_2A</strong>, il sera posssible adresser un mail à l\'ensemble des membres de ce groupe en postant un mail à l\'adresse suivante : <strong><em>Classe_2A@lcs</em></strong> .')\"><img src='../images/help-info.gif'></u>\n";
    }
