...
echo "<hr /><h3>".get_vocab("suppression automatique des réservations")."</h3>";
echo get_vocab('Explications suppression automatique des réservations').grr_help("aide_grr_verif_auto_grr");
echo "<table cellspacing=\"5\">";
