...
if (isset($_GET['newDay'])) {
    $sql = "update grr_calendrier_jours_cycle set Jours =".$_GET['newDay']." WHERE DAY = ".$_GET['date'];
    mysql_query($sql);
...
echo "<label>".get_vocab("nouveau_jour_cycle");
    ...
    $result = mysql_query("SELECT * FROM grr_setting WHERE NAME='nombre_jours_Jours/Cycles'");
