...
# print the page header
    ...
    echo "<td><input type=\"text\" name=\"type_name\" value=\"".grr_htmlSpecialChars($row["type_name"])."\" size=\"20\" /></td>\n";
    echo "</tr><tr>\n";
    ...
    echo "<td><input type=\"text\" name=\"order_display\" value=\"".grr_htmlSpecialChars($row["order_display"])."\" size=\"20\" /></td>\n";
    echo "</tr>";
