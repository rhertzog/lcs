...
if ($etape==3) {
    ...
    foreach ( $rooms as $room_id ) {
        ...
        $area_id = grr_sql_query1("SELECT area_id FROM grr_room WHERE id = '".$room_id."'");
        $test_enable_periods_y += grr_sql_query1("select count(enable_periods) FROM grr_area WHERE (id = '".$area_id."' and enable_periods='y')");
        $test_enable_periods_n += grr_sql_query1("select count(enable_periods) FROM grr_area WHERE (id = '".$area_id."' and enable_periods='n')");
