...
for ($cday = 1; $cday <= $days_in_month; $cday++)
{
    ...
    echo "<div class=\"monthday\"><a title=\"".grr_htmlSpecialChars(get_vocab("see_all_the_rooms_for_the_day"))."\"   href=\"day.php?year=$year&amp;month=$month&amp;day=$cday&amp;area=$area\">".$name_day;
     ...
     if (isset($d[$cday]["id"][0]))
     {
        ...
        for ($i = 0; $i < $n; $i++)
        {
          if ($verif_acces_ressource[$d[$cday]["id_room"][$i]]) { // On n'affiche pas les réservation des ressources non visibles pour l'utilisateur.
            ...
            echo $d[$cday]["data"][$i]
                . "<br /><i><b>"
                . grr_htmlSpecialChars($d[$cday]["room"][$i])
                . "</b></i><br />";
