...
if (getSettingValue("use_fckeditor") == 1) {
      ...
      echo grr_htmlSpecialChars(getSettingValue('message_accueil'));
      echo "</textarea>\n";
?>
...
<?php
        ...
        echo "\n<textarea name=\"message_accueil\" rows=\"8\" cols=\"120\">".grr_htmlSpecialChars(getSettingValue('message_accueil'))."</textarea>\n";
    }
echo "</p>";
