...
for ($cday = 1; $cday <= $days_in_month; $cday++)
{
    ...
    echo "<td valign=\"top\" class=\"cell_month\">\n<div class=\"monthday\"><a title=\"".grr_htmlSpecialChars(get_vocab("see_all_the_rooms_for_the_day"))."\"   href=\"day.php?year=$year&amp;month=$month&amp;day=$cday&amp;area=$area\">".$name_day;
