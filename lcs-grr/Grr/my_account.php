    ...
    $flag_virgule = 'n';
     ...
     if (IsAllowedToModifyProfil()) {
      if (trim($reg_nom) != '')
      {
       ...
       $flag_virgule = 'y';
       $_SESSION['nom'] = grr_htmlSpecialChars($reg_nom);
      }
      if (trim($reg_prenom) != '')
      {
       ...
       $flag_virgule = 'y';
       $_SESSION['prenom'] = grr_htmlSpecialChars($reg_prenom);
      }
     }
...
// Modifs possibles
   ...
   if ($user_nom)
     echo grr_htmlSpecialChars($user_nom);
   echo('" size="30" /></td>
        </tr>');
   ...
   if ($user_prenom)
     echo grr_htmlSpecialChars($user_prenom);
   echo('" size="30" /></td>
        </tr>');
 }
...
// Pas de modif possible
 if (!(IsAllowedToModifyEmail()))
 {
   ...
   if ($user_email)
     echo grr_htmlSpecialChars($user_email);
   echo('" size="30" /></td>
        </tr>');
 }
