...
if ($res) for ($i = 0; ($row = grr_sql_row($res, $i)); $i++)
{
    ...
    if ($is_admin=='yes') {
        ...
        echo "<b>";
        echo grr_htmlSpecialChars($row[1])." ".grr_htmlSpecialChars($row[2])."</b> | <a href='admin_right_admin.php?action=del_admin&amp;login_admin=".urlencode($row[0])."&amp;id_area=$id_area'>".get_vocab("delete")."</a><br />";
    }
}
if ($exist_admin=='no') {
