...
$menuExtras = array ();
//Modif LCS
$menuExtras[1] =  array ( 'menu', 'Emplois du temps', '',
  array (
    array ( 'item', 'calendar_add.png ', 'Importer &#224; l\'unit&#233; ', 'lcs_import_one_edt.php '),
    array ( 'item', 'compress.png', 'Importer en masse', 'lcs_import_multi_edt.php '),
    array ('item', 'page_edit.png', 'Compte-rendu d\'importation en masse', 'lcs_import_cr.php')
      )
);
    //eom
