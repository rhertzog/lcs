					...
					if(isset($tabtmp[$index[5]])) {
						if($tabtmp[$index[5]]!="") {
							...
							if($temoin==0) {
								...
								//$eleve[$numero]["nom"]=mb_ereg_replace("[^A-Za-zÆæ¼½ÂÄÀÁÃÅÇÊËÈÉÎÏÌÍÑÔÖÒÓÕØ¦ÛÜÙÚÝ¾´áàâäãåçéèêëîïìíñôöðòóõø¨ûüùúýÿ¸_ -]", "", $tabtmp[$index[0]]);
								//$eleve[$numero]["prenom"]=mb_ereg_replace("[^A-Za-zÆæ¼½ÂÄÀÁÃÅÇÊËÈÉÎÏÌÍÑÔÖÒÓÕØ¦ÛÜÙÚÝ¾´áàâäãåçéèêëîïìíñôöðòóõø¨ûüùúýÿ¸_ -]", "", $tabtmp[$index[1]]);
								...
								//$nom=mb_strtolower(strtr(mb_ereg_replace("Æ","AE",mb_ereg_replace("æ","ae",mb_ereg_replace("¼","OE",mb_ereg_replace("½","oe","$nom"))))," 'ÂÄÀÁÃÄÅÇÊËÈÉÎÏÌÍÑÔÖÒÓÕ¦ÛÜÙÚÝ¾´áàâäãåçéèêëîïìíñôöðòóõ¨ûüùúýÿ¸","__AAAAAAACEEEEIIIINOOOOOSUUUUYYZaaaaaaceeeeiiiinoooooosuuuuyyz"));
								//$prenom=mb_strtolower(strtr(mb_ereg_replace("Æ","AE",mb_ereg_replace("æ","ae",mb_ereg_replace("¼","OE",mb_ereg_replace("½","oe","$prenom"))))," 'ÂÄÀÁÃÄÅÇÊËÈÉÎÏÌÍÑÔÖÒÓÕ¦ÛÜÙÚÝ¾´áàâäãåçéèêëîïìíñôöðòóõ¨ûüùúýÿ¸","__AAAAAAACEEEEIIIINOOOOOSUUUUYYZaaaaaaceeeeiiiinoooooosuuuuyyz"));
			...
			if($temoin_matieres==1) {
				...
				if($temoin_mat==1) {
					...
					if(mb_strstr($ligne[$cpt],"<LIBELLE_COURT>")) {
						...
						//$matiere[$i]["libelle_court"]=trim(mb_ereg_replace("[^A-Za-zÆæ¼½ÂÄÀÁÃÅÇÊËÈÉÎÏÌÍÑÔÖÒÓÕØ¦ÛÜÙÚÝ¾´áàâäãåçéèêëîïìíñôöðòóõø¨ûüùúýÿ¸0-9&_. -]","",html_entity_decode($tabtmp[2])));
				...
				*/
				...
				if($temoin_prof==1) {
					...
					if(mb_strstr($ligne[$cpt],"<NOM_USAGE>")) {
						...
						//$prof[$i]["nom_usage"]=trim(mb_ereg_replace("[^A-Za-zÆæ¼½ÂÄÀÁÃÅÇÊËÈÉÎÏÌÍÑÔÖÒÓÕØ¦ÛÜÙÚÝ¾´áàâäãåçéèêëîïìíñôöðòóõø¨ûüùúýÿ¸ -]","",$tabtmp[2]));
					...
					if(mb_strstr($ligne[$cpt],"<NOM_PATRONYMIQUE>")) {
						...
						//$prof[$i]["nom_patronymique"]=trim(mb_ereg_replace("[^A-Za-zÆæ¼½ÂÄÀÁÃÅÇÊËÈÉÎÏÌÍÑÔÖÒÓÕØ¦ÛÜÙÚÝ¾´áàâäãåçéèêëîïìíñôöðòóõø¨ûüùúýÿ¸ -]","",$tabtmp[2]));
					...
					if(mb_strstr($ligne[$cpt],"<PRENOM>")) {
						...
						//$prof[$i]["prenom"]=trim(mb_ereg_replace("[^A-Za-zÆæ¼½ÂÄÀÁÃÅÇÊËÈÉÎÏÌÍÑÔÖÒÓÕØ¦ÛÜÙÚÝ¾´áàâäãåçéèêëîïìíñôöðòóõø¨ûüùúýÿ¸_. -]","",$tabtmp[2]));
