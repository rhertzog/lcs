...
$flog = creation_log($pu,$version,3); // il s'agit d'un log de mise à jour
...
if ($etape == 4) // exécution du script patchconf de l'installation
        {
...
if ($etape == 6) // Insertion d'entrée dans l'annuaire ldap
	{
...
if ($etape == 7) // Execution des scripts de mise à jour
	{
...
if ($etape == 9) // fin de la mise à jour
	{
