...
foreach $entry ($res->entries) {
  ...
  # FIN DEBUG
  ############
  # print "/usr/share/lcs/sbin/groupDelEntry.pl $dn $dnWhereToDel\n";

  system("/usr/share/lcs/sbin/groupDelEntry.pl $dn $dnWhereToDel");
}
...
foreach $entry2 ($res2->entries) {
  ...
  #   }
  # }
  # print "/usr/share/lcs/sbin/groupDelEntry.pl $dn $dnWhereToDel2\n";

  system("/usr/share/lcs/sbin/groupDelEntry.pl $dn $dnWhereToDel2");
}
...
foreach $entry3 ($res3->entries) {
  ...
  #   }
  # }
  # print "/usr/share/lcs/sbin/groupDelEntry.pl $dn $dnWhereToDel3\n";
