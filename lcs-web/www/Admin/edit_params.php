	...
	if ($result) {
		...
		while ($r=mysqli_fetch_array($result)) {
                                            ...
                                            if ($result1)
                                                    ...
                                                    "</strong>".gettext(" en ")."<strong>".$formnamepurif."</strong>"."<br />\n";
