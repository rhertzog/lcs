...
font.setAttribute("src", "http://recitmst.qc.ca/wikinimst/ui2/graphic_support/numeric.png");
signs = {
...
function notOperaFix() {
	...
	if ((isIE && notIE7) && document.styleSheets && document.styleSheets[0]) {
		document.styleSheets[0].addRule('img', 'behavior: url(http://recitmst.qc.ca/wikinimst/ui2/graphic_support/iepngfix.htc)');
		document.styleSheets[0].addRule('div', 'behavior: url(http://recitmst.qc.ca/wikinimst/ui2/graphic_support/iepngfix.htc)');
		document.styleSheets[0].addRule('.slide', 'behavior: url(http://recitmst.qc.ca/wikinimst/ui2/graphic_support/iepngfix.htc)');
	}
}
...
function createNotesWindow() { // creates a window for our notes
	if (!s5NotesWindow || s5NotesWindow.closed) { // Create the window if it doesn't exist
		...
		s5NotesWindow = window.open('http://recitmst.qc.ca/wikinimst/ui2/s5-notes.html', 's5NotesWindow', 'top=0,left=0');
	}
...
function createProgress() {
	...
	pg.style.backgroundImage="url(http://recitmst.qc.ca/wikinimst/ui2/graphic_support/progress.gif)";
	document.getElementsByTagName("body")[0].insertBefore(pg,obj);

	var im = document.createElement('img');
	im.id = "StartupControl";
	im.src = "http://recitmst.qc.ca/wikinimst/ui2/graphic_support/blank.gif?" + new Date().valueOf();
...
function byby() {
	...
	if(tranSitions && fadeModus && s5mode && !isOp) {
		...
		pg.style.backgroundPosition="center center";
		pg.style.backgroundRepeat="no-repeat";
		pg.style.backgroundImage="url(http://recitmst.qc.ca/wikinimst/ui2/graphic_support/finish.gif)";		
...
function createHelpReq() {
	if(!document.getElementById("HelpReq")) {
		...
		pg.style.backgroundPosition="center center";
		pg.style.backgroundRepeat="no-repeat";
		pg.style.backgroundImage="url(http://recitmst.qc.ca/wikinimst/ui2/graphic_support/help.jpg)";
		document.getElementsByTagName("body")[0].insertBefore(pg,obj);
		if(document.getElementById("HelpReq")) {
			helpmode = true;
		}
...
if(!isIE && !isOp) {
	document.write('<script type="text/javascript" src="http://recitmst.qc.ca/wikinimst/ui2/audio_support/soundmanager2.js"></script>');
	if(typeof soundManager!="undefined") {
		var allMetas = document.getElementsByTagName('meta');
		for (var i = 0; i< allMetas.length; i++) {
