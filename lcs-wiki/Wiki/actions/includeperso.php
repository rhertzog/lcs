...
if (empty($incPage['name'])) {
	...
	if ($classes)
	{
		if ($incPage['isLocal']==TRUE){
		echo "<div style=\"text-align: right;\"><small><span
		style=\"font-style: italic;\"><a href=\"$lienpage\">Page externe!</a></span></small><br></div>";}
