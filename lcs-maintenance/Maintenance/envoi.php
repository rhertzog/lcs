	...
	list ($idpers,$uid)= isauth();
  	if ($idpers == "0") {
		...
		if(empty($nom) OR empty($secteur) OR empty($bat) OR empty($salle) OR empty($poste) OR empty($se) OR empty($texte)) {
    			echo "<table width=\"50%\" border=0 align=center bgcolor=\"#FF0000\">
					<tr><td align=center>
						<p>&nbsp;</p><h3><font color=\"#FFFFFF\"><b>ATTENTION!</b><br> <u> Vous devez compl&#233;ter tous les champs marqu&#233;s '*'!</u></font></h3>
						<p>&nbsp;</p>
					<tr><td align=center bgcolor=\"#ffffff\">
						<br>
						<table width=100 border=\"ridge #ffffff 3px\" align=center bgcolor=\"#336699\">
							<tr><td align=center >
								<a href=\"javascript:history.go(-1)\"><font color=\"#FFFFFF\"> &lt;&lt; Retour</font></a>
							</td></tr>
						</table>
					<br></td></tr>
				</table>";
		...
		//si tous les champs obligatoires sont remplis
			...
			echo "  	<table width=580><tr><td>
					<h4>Merci ",ucwords($prenom)," ",strtoupper($nom),"</h4>
					<p>Nous sommes le $daterequete<br>Vous avez d&#233;clar&#233; un dysfonctionnement de l'ordinateur N° <b>",strtoupper($poste),"</b> , marque <b>$marque</b> ,
						...
						<br>
						<!--table width=100 border=\"ridge #ffffff 3px\" align=center bgcolor=\"#FFFFFF\">
							<tr>
								<td align=center >
									<a href=index.php><font color=\"#000000\"> &lt;&lt; Retour</font></a>
								</td>
							</tr>
						</table-->
					</td></tr></table> ";
