...
function html() {
    ...
    //$header .= "<script type='text/javascript' src='Scripts/maint2.js'></script>";
...
function Aff_mnu($mode) {
    ...
    if ($mode=="user") $header.="      <a class='menu_haut demand_sup' href='demande_support.php?jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/demande_support.php'))."'title='Effectuer une demande de support'><img src='Style/img/hand_point_090.png'/>&nbsp;Demande de support&nbsp;</a>";
    else $header.="<a class='menu_haut demand_sup' href='demande_support.php?jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/demande_support.php'))."'title='Signaler une intervention non sollicit&#233;e'><img src='Style/img/hand_point_090.png'/>&nbsp;Intervention non sollicit&eacute;e&nbsp;</a>";
    $header.= "<a class='menu_haut wait' href='index.php?mnuchoice=wait&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."' title='Les demandes en attente de prise en charge'><img src='Style/img/en-attente.png'/>En attente</a>&nbsp;";
    $header.="<a class='menu_haut myspool' href='index.php?mnuchoice=myspool&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."' title='Vos demandes en cours de traitement'><img src='Style/img/bug_user.png'/>Votre Encours&nbsp;</a>";
    if ($mode=="user") $header.= "<a class='menu_haut myhistorique' href='index.php?mnuchoice=myhistorique&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."' title='Historique de vos demandes'><img src='Style/img/en-attente.png'/>Votre historique&nbsp;</a>";
    if ($mode=="team" || $mode=="team_CR") {
        $header.= "<a class='menu_haut spool' href='index.php?mnuchoice=spool&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."' title='En cours g&#233;n&#233;ral'><img src='Style/img/bug_go.png'/>Encours gen.&nbsp;</a>";
        $header.= "<a class='menu_haut myhistorique ' href='index.php?mnuchoice=myhistorique&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."' title='Historique de vos interventions'><img src='Style/img/myhistorik.png'/>Votre historique&nbsp;</a>";
        $header.= "<a class='menu_haut historique' href='index.php?mnuchoice=historique&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."' title='Historique g&#233;n&#233;ral des interventions'><img src='Style/img/clock_history_frame.png'/>Historique gen.&nbsp;</a>";
    }
    // Affichage du menu de configuration
    if (is_admin("system_is_admin",$uid)=="Y")
      $header.="<a class='menu_haut config' href='config.php?conf=mail&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/config.php'))."' title=\"Configurer l'application\"><img src='Style/img/setting_tools.png'/>Configuration&nbsp;</a>";
...
function Aff_bar_mode ($message) {
        ...
        if ( $mode == "team" ) {
            ...
            if ( mb_ereg ("^En", $message) || mb_ereg ("^Votre", $message) ||$message == "Historique gen." ) {
                ...
                $header .= "<div class='order'><A class='menu_barre' href='index.php?mnuchoice=$mnuchoice&tri=prisencharge&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."'>Prise en charge par</A><img alt=\"DESC\" src=\"Images/bullet_arrow_down.png\" hspace=\"4\" border=0></div>";
                $header .= "<div class='order'><A class='menu_barre' href='index.php?mnuchoice=$mnuchoice&tri=emetteur&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."'>Emetteur</A><img alt=\"ASC\" src=\"Images/bullet_arrow_up.png\" hspace=\"4\" border=0></div>";
                $header .= "<div class='order'><A class='menu_barre'  href='index.php?mnuchoice=$mnuchoice&tri=date&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."'>Date</A><img alt=\"DESC\" src=\"Images/bullet_arrow_down.png\" hspace=\"4\" border=0></div></td>\n";
...
function Aff_feed_wait ($mode, $filter,$tri) {
    ...
    while($row = mysql_fetch_array($requete)) {
        ...
        BoostAlert ( $NumBoost );
        if ($mode == "team") {
            echo "<a class='menu_feed' href='index.php?Rid=$Rid&action=take&mnuchoice=$mnuchoice&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."'><img src='Style/img/16/accept.png' alt=''/>&nbsp;Prendre en charge&nbsp;</a>&nbsp;";
            echo "<a class='menu_feed' href='index.php?Rid=$Rid&action=del_task&mnuchoice=$mnuchoice&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."'><img src='Style/img/16/delete.png' alt=''/>&nbsp;Supprimer&nbsp;</a>&nbsp;";
        } else {
            echo "<a class='menu_feed' href='index.php?Rid=$Rid&action=del_task&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."'><img src='Style/img/16/delete.png' alt=''/>&nbsp;Supprimer&nbsp;</a>&nbsp;";
            echo "<a class='menu_feed' href='edit_demande.php?Rid=$Rid&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/edit_demande.php'))."'><img src='Style/img/16/bug_edit.png' alt=''/>&nbsp;Modifier</a>&nbsp;";
            if ( VerifTime ($OpenTimeStamp, $BoosTimeStamp) )
            echo "<a class='menu_feed' href='index.php?Rid=$Rid&action=relance&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."'><img src='Style/img/16/arrow_refresh.png' alt=''/>&nbsp;Relancer</a>&nbsp;";
        }
         echo "</td>\n</tr>\n</table>\n";
    }  //fin du while
}
    ...
    while($row = mysql_fetch_array($requete)) {
        ...
        if ( $mode == "team" ) {
            if ( $mnuchoice == "myspool" ) {
                echo "<div style=\"float:right;\"><a class='menu_feed' href='bring_back.php?Rid=$Rid&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/bring_back.php'))."'><img src='Style/img/16/comment_edit.png' alt=''/>&nbsp;Rapport d'intervention</a>&nbsp;";
                echo "<a class='menu_feed' href='index.php?Rid=$Rid&action=del_task&mnuchoice=$mnuchoice&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."'><img src='Style/img/16/delete.png' alt=''/>&nbsp;Supprimer&nbsp;</a>&nbsp;</div>";
                ...
                if ( VerifTime ($OpenTimeStamp, $BoosTimeStamp) )
                echo "<a class='menu_feed' href='index.php?Rid=$Rid&action=relance&mnuchoice=$mnuchoice&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."'>Relancer</a>&nbsp;";
        ...
        while($row1 = mysql_fetch_array($requete1)) {
                ...
                if ( $mode == "team" && $mnuchoice=="myspool") {
                    $html .= "<br><a class='menu_feed' href='index.php?Rid=$Rid&action=del_cr&mnuchoice=$mnuchoice&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/index.php'))."'><img src='Style/img/16/delete.png' alt=''/>&nbsp;Supprimer&nbsp;</a>&nbsp;\n";
                    $html .= "<a class='menu_feed' href='bring_back_mod.php?Rid=$Rid&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/bring_back_mod.php'))."'><img src='Style/img/16/bug_edit.png' alt=''/>&nbsp;Modifier</a>&nbsp;\n";
                }
                $html .="</td></tr>\n";
                $html .= "</table></div>\n";
                echo "$html";
...
function Aff_bringback_mod_form($Rid,$Author, $AuthorMail) {
    ...
    if ( !isset($post) ) {
            ...
            $html .= "<form action='bring_back_mod.php?Rid=$TopRid&amp;jeton=".md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/bring_back_mod.php'))."' method='POST'>\n";
            ...
            $html .="&nbsp;<select name='unit'>\n<option>mn</option>\n<option>h</option>\n</select>\n</td>\n";
            $html .= "<td class='tableau'><label for='Cost'>Co&ucirc;t des pi&#232;ces de rechange</label>&nbsp;<input type='text' id='Cost' name='Cost' value='$Cost' size='4' maxlength='4'>&nbsp;&#8364;&nbsp;</td>\n";
            ...
            $html.='<input name="jeton" type="hidden"  value="'.md5($_SESSION['token'].htmlentities('/Plugins/Maintenance/bring_back_mod.php')).'" />';
            $html .= "<input type='reset' value='Recommencer' name='reset' class='button'>\n";
            $html .= "</td></tr>\n</table>\n";
            echo $html;
    } else {
...
function read_cr_task ($Rid) {
    /*
            ...
            07 - Cost : Cout des Ã©ventuels pièces de rechange
    */
    global $DEBUG;
    // Recherche dans la table maint_task si il existe des demandes en attente de traitement
